...
export const COMMANDS: readonly CommandEntry[] = [
  ...
  { name: "approve", group: "decide",
    ...
    usage: "approve <call_id> [--reason R] [--remember | --remember-as JSON | --preview] [--json]",
    handler: cmdApprove },
  { name: "reject", group: "decide",
    summary: "Reject a paused tool call.",
    usage: "reject <call_id> [--reason R] [--remember | --remember-as JSON | --preview] [--json]",
    handler: cmdReject },
  { name: "defer", group: "decide",
    summary: "Defer a paused tool call to the human to run locally.",
    usage: "defer <call_id> [--reason R] [--remember | --remember-as JSON | --preview] [--json]",
    handler: cmdDefer },
