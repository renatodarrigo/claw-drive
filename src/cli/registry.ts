...
export const COMMANDS: readonly CommandEntry[] = [
  ...
  { name: "start", group: "lifecycle",
    ...
    usage: "start --cwd <path> [--policy FILE] [--brief FILE] [--name <alias>] [--no-wrapper] [--fleet TAG]",
    handler: cmdStart },
  { name: "send", group: "lifecycle",
    summary: "Send B a user turn; --all broadcasts to every live session in the fleet view.",
  ...
  { name: "sessions", group: "observe",
    summary: "List the sessions in the fleet view, including orphaned ones.",
    usage: "sessions [--fleet TAG] [--all-fleets]",
    handler: cmdSessions },
  { name: "status", group: "observe",
    summary: "Snapshot of one session or the fleet view: state, turn, pending decisions, recent errors.",
  ...
  { name: "watch", group: "observe",
    summary: "Stream human-actionable events as JSONL for Monitor; --all merges the fleet view's live sessions.",
    usage: "watch <session|--all> [--replay|--since N] [--fleet TAG] [--all-fleets]",
    handler: cmdWatch },
  { name: "pending", group: "observe",
    summary: "List tool calls awaiting a human decision in the fleet view.",
    usage: "pending [<session>] [--fleet TAG] [--all-fleets]",
    handler: cmdPending },
  // Resolve decisions
  { name: "approve", group: "decide",
    summary: "Approve a paused tool call found in the fleet view.",
    usage: "approve <call_id> [--reason R] [--remember | --remember-as JSON | --preview] [--json] [--fleet TAG] [--all-fleets]",
    handler: cmdApprove },
  { name: "reject", group: "decide",
    summary: "Reject a paused tool call found in the fleet view.",
    usage: "reject <call_id> [--reason R] [--remember | --remember-as JSON | --preview] [--json] [--fleet TAG] [--all-fleets]",
    handler: cmdReject },
  { name: "defer", group: "decide",
    summary: "Defer a paused tool call in the fleet view to the human to run locally.",
    usage: "defer <call_id> [--reason R] [--remember | --remember-as JSON | --preview] [--json] [--fleet TAG] [--all-fleets]",
    handler: cmdDefer },
  { name: "provide-output", group: "decide",
    summary: "Relay a human-run command's output back to a deferred call in the fleet view.",
    usage: "provide-output <call_id> [--stdout S] [--stderr S] [--exit N] [--extra S] [--from-file PATH] [--fleet TAG] [--all-fleets]",
  ...
  { name: "prune", group: "maintenance",
    summary: "Delete old stopped/orphaned session dirs in the fleet view.",
    usage: "prune [--older-than 24h] [--force] [--fleet TAG] [--all-fleets]",
    handler: cmdPrune },
];
